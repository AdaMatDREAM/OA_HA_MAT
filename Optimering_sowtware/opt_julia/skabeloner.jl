...
if model_type == "MIP"
    ...
    x_type = [:Binary, :Binary, :Binary, :Binary, :Binary, :Binary, :Binary, :Binary, :Binary];
...
output_latex_navn = joinpath(output_mappe, "test_primal_2.tex")

output_fil_navn_D = joinpath(output_mappe, "test_dual_2.txt")
output_latex_navn_D = joinpath(output_mappe, "test_dual_2.tex")
