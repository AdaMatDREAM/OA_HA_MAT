...
if P.model_type == "LP"
    standard_LP_output(M, x, P.x_navne, P.c, constraints, P.b, P.b_dir, P.b_navne,
    P.dec, P.tol, P.output_terminal, P.output_fil, P.output_latex, 
    P.output_fil_navn, P.output_latex_navn, P.model_type, P.x_type)
    ...
    if P.dual_defined == true
        ...
        standard_LP_output(M_D, y, D.y_navne, D.c_D, constraints_D, D.b_D, D.b_dir_D, D.b_D_navne,
        P.dec, P.tol, P.output_terminal, P.output_fil, P.output_latex, 
        P.output_fil_navn_D, P.output_latex_navn_D, P.model_type, D.y_type)
    end
elseif P.model_type == "MIP"
    standard_MIP_output(M, x, P.x_navne, P.x_type, P.c, constraints, P.b, P.b_dir, P.b_navne,
    P.dec, P.tol, P.output_terminal, P.output_fil, P.output_latex, 
    P.output_fil_navn, P.output_latex_navn, P.model_type)
end 