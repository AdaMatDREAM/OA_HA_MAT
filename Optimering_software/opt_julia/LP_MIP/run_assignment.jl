...
include("Assignment_problem_skabelon.jl")

# Indlæs modellen og indstillinger
# Syntax P.[variabelnavn]
P = Assignment_problem_skabelon()
...
# Assignment problemet er et MIP problem (binary variabler)
if P.model_type == "MIP"
    if P.output_terminal
        ...
        # Print assignment matrix hvis optimal løsning (modellen er allerede optimeret i standard_MIP_output)
    ...
    error("Assignment problemet skal være et MIP problem (model_type = \"MIP\")")
end
